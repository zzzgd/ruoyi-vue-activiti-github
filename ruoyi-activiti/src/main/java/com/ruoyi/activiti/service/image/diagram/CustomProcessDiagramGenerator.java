package com.ruoyi.activiti.service.image.diagram;
...
/**
 * Class to generate an image based the diagram interchange information in a BPMN 2.0 process. 在 BPMN 2.0 流程中基于图表交换信息生成图像的类。
 *
 * @author Joram Barrez
...
public class CustomProcessDiagramGenerator implements ICustomProcessDiagramGenerator {
  ...
  /**
   * The instructions on how to draw a certain construct is created statically and stored in a map for performance.
   */
...
//                processDiagramCanvas.drawLabel(sequenceFlow.getName(), lineCenter, true);
  ...
  /**
   * This method returns shape type of base element.<br> Each element can be presented as rectangle, rhombus, or ellipse.
   *
   * @param baseElement
